...
Write-Host ""
    ...
    Write-Host "  Prüfe, ob http://localhost:3002 erreichbar ist..." -ForegroundColor Yellow
    try {
    ...
    Write-Host "  Konnte http://localhost:3002 nicht erreichen. Bitte Dev-Fenster und Logs prüfen." -ForegroundColor Red
}
